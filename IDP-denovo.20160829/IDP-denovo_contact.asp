...
<p class="page_title_area_lower">Latest News:  IDP-denovo_v.1 is released <a href="default.asp#news">read more</a></p>
  ...
  <div id="content">
    <h2>Contact</h2>
    <p>We welcome any comments, suggestions, questions or bug reports. <br>
    For all the enquiries, please contact Kin Fai Au: <b>KinFai(dot)Au(at)osumc(dot)edu</b>. </p>
    <p>Alternatively, you can post your question on <a href="http://seqanswers.com/forums/forumdisplay.php?f=18">SEQanswers forums</a>
    with "IDP" in the title.</p>
    <p>
    If you would like to report a bug or crash, please include in your email the following:
    </p>
    <ul>
    <li>The error message.</li>
    <li>The commands issued which caused errors.</li>
    <li>Any relevant errors or output.</li>
    <li>If possible, a sample of the reads you used so that we can re-create the error.</li>
    </ul>
    <p>
    Remember, the <b>more</b> that you include in your email, the easier it is for us to help you. 
    </p>
    
    <h3><img src="images/dna.png"> Authors</h3>
    IDP-denovo is developed by the <a href="http://www.augroup.org/">Kin Fai Au Lab</a>. 
  </div>
...
<div id="sidebar">
    <h2>Site Map</h2>
    <ul>
      <li><a href="idp-denovo.html">Home</a></li>
      
      <li><a href="IDP-denovo_download_current.html">Downloads</a></li>
      <li><a href="IDP-denovo_contact.html">Contact</a></li>
      <li><a href="IDP-denovo_requirements.html">Requirements</a></li>
      <li><a href="IDP-denovo_howitworks.html">How it works?</a></li>

  <li><a href="IDP-denovo_faq.html">FAQ</a></li>
    ...
    <ul>
      ...
      <li><a href="IDP-denovo_guide.html">Manual</a></li>
      <li><a href="IDP-denovo_tutorial.html">Tutorial</a></li>
      
    </ul>
    <h2>Download</h2>
    <h3>Current release</h3>
    <ul>
      <li><a href="IDP-denovo_download_current.html"><img src="images/download.png"> IDP-denovo 0.2 </a> (<a href="IDP-denovo_download_current.html#notes">notes</a>)</li>
    </ul>
...
<ul>
      <li><a href="http://www.augroup.org/GenoClone/GenoClone/">GenoClone</a> - Reveal tumor heterogeneity</li>
    </ul>
...
<div id="footer">
    <ul>
      ...
      <li><a href="http://www.osu.edu">The Ohio State University</a>, OH 43210.</li>
    </ul>
</div>
