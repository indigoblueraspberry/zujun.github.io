...
<div id="content_container">
  ...
  <div id="content">
    ...
    <ul>
   <a href="IDP-fusion_download_current.asp"><img src="images/download.png"><b>The latest release of IDP-fusion</b></a><br>
   ...
   <p>Uncompress and extract the directory in a location of your choice to get an example working directory containing a data subfolder and configuration files.</p>
    ...
    <blockquote>
    <pre>
      $ ls MCF7_chr17q23-25chr20q13_Example/
      Data/ output_example/ run_fasta.cfg run_psl.cfg temp_example/
    ...
    run IDP on your data, all of these files can be in separate locations if you wish. 
     <dl>
      ...
      <dd>These are the configuration files for two types of <a href="IDP-fusion_manual.asp#longreads">long read input data</a>. Thus, you can use both of them to run the example data. The configuration file is a text file that contains the path to your data and the configuration settings. Please see <a href="IDP-fusion_cfg.asp">.cfg file format</a> for 
    ...
    <table>
      ...
      <tr><td>ensGene_20140313.chr17chr20.gpd</td><td><a href="IDP_gpd_format.asp">genepred (GPD)</a> format file for ensembl transcripts, used for the secondary annotation of fusion sites</td></tr>

      <tr><td>gmap_index.chr17chr20/</td><td>Folder contains the GMAP index files built from the example's reference genome.</td></tr>
      <tr><td>hg19.chr17chr20.gene_est.refFlat.txt</td><td><a href="IDP_gpd_format.asp">genepred (GPD)</a> format file for the whole genome splicing data from multiple sources including ESTs and reference genome databases.</td></tr>
      ...
      <tr><td>refFlat_20140611.chr17chr20.gpd.txt</td><td><a href="IDP_gpd_format.asp">genepred (GPD)</a> format reference genepred file used to annotated transcript.</td></tr>
