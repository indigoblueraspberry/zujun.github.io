...
if len(sys.argv) >= 3:
    ...
    print ("usage: python novel_genepred.py ref_refFlat_filename tag_refFlat_filename  output_filename")
    print ("or ./novel_genepred.py ref_refFlat_filename tag_refFlat_filename output_filename")
    sys.exit(1)
