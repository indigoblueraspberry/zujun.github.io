...
<div id="content_container">
  ...
  <div id="content">
    ...
    <tr>
    <td>
    <a href="files/IDP_0.1.8.tar.gz"  onClick="ga('send', 'event', 'file download', 'click', 'IDP download release');"><img src="images/download.png"><b>IDP 0.1.8</b></a>
    </td>
     <td>
    ...
    <div id="notes">
    <h3><img src="images/dna.png">  <b>IDP 0.1.8</b> - Release Notes</h3>
    </div>
   <p>
   IDP integrates short reads (e.g. Illumina data) and long reads (e.g. PacBio data) to identify gene isoforms (transcripts) from transcriptome (see Figure above).<br>
    ...
    <h3>Changes in version 0.1.8<br></h3>
<ul>
  <li> A bug causing causing lowercased genes to be ommitted from the output was corrected.</li>
  <li> An occasional divide by zero error in the false positive rate calculation was corrected.</li>
</ul>
