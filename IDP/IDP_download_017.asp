...
<div id="content_container">
  ...
  <div id="content">
    ...
    <tr>
    <td>
    <a href="files/IDP_0.1.7.tar.gz"  onClick="ga('send', 'event', 'file download', 'click', 'IDP download release');"><img src="images/download.png"><b>IDP 0.1.7</b></a>
    </td>
     <td>
    ...
    <div id="notes">
    <h3><img src="images/dna.png">  <b>IDP 0.1.7</b> - Release Notes</h3>
    </div>
   <p>
   IDP integrates short reads (e.g. Illumina data) and long reads (e.g. PacBio data) to identify gene isoforms (transcripts) from transcriptome (see Figure above).<br>
    ...
    <h3>Changes in version 0.1.7<br></h3>
<ul>
  <li> A bug causing predicted isoforms to have the wrong strand information in the genepred output has been fixed.</li>
  <li> A utilities folder containing scripts for converting between GTF and genepred formats has been added.</li>
</ul>
