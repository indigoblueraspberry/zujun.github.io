...
<head>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $('#download_IDP').click(function(){
        dataLayer.push({
          'event':'gaEvent',
          'eventCategory':'Download'
          'eventAction':'Click',
          'eventLabel':'Download IDP'
        });
      });
    });
  </script>
...
<div id="content_container">
  ...
  <div id="content">
    ...
    recommend</b> that you consult the <a href="IDP_tutorial.html">tutorial</a> before attempting to use IDP. 
    </p>
        
    <table border="1" cellpadding="1">
    <tr>
    <td>
    <a id="download_IDP" href="files/IDP_0.1.2.tar.gz"><img src="images/download.png"><b>IDP 0.1.2</b></a>
    </td>
     <td>
    ...
    <div id="notes">
    <h3><img src="images/dna.png">  <b>IDP 0.1.2</b> - Release Notes</h3>
    </div>
   <p>
   IDP integrates short reads (e.g. Illumina data) and long reads (e.g. PacBio data) to identify gene isoforms (transcripts) from transcriptome (see Figure above).<br>
    ...
    <h3>Changes in version 0.1.2<br></h3>
    <ul>
      <li>The parameter read_length is now set in the run.cfg file</li>
      <li>Removed dependencies on python argparse and cython modules</li>
      <li>Added a python_path option in cfg file in case the default "/usr/bin/python" is not suitable</li>
      <li>Improved handling of I/D in CIGAR strings as insertions/deletions in exon regions</li>
      <li>Deleted intermediate files generated in MLT_MT.py and parseSAM_MT.py scripts</li>
	  </ul>
