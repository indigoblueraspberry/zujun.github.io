...
<div id="content_container">
  ...
  <div id="content">
    ...
    <tr>
    <td>
    <a href="files/IDP_0.1.rar" onClick="ga('send', 'event', 'file download', 'click', 'IDP code download');><img src="images/download.png"><b>IDP 0.1</b></a>
    </td>
     <td>
    Please see the <a href="IDP_download_01.asp#notes">release notes</a> for 
    more information
    </td>
    </tr>
    ...
    <div id="notes">
    <h3><img src="images/dna.png">  <b>IDP 0.1</b> - Release Notes</h3>
    </div>
   <p>
