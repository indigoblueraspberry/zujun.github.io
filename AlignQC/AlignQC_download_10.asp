...
<div id="content_container">
  ...
  <div id="content">
    ...
    <tr>
    <td>
    <a href="files/AlignQC-1.0.tar.gz"  onClick="ga('send', 'event', 'file download', 'click', 'AlignQC download release');"><img src="images/download.png"><b>AlignQC-1.0.tar.gz</b></a>
    </td>
     <td>
    ...
    <div id="notes">
    <h3><img src="images/dna.png">  <b>AlignQC-1.0 07-08-2016</b> - Release Notes</h3>
    </div>
   <p>
   AlignQC analyzes alignment files and reports alignment statistics and error pattern analyses in an easily shared format.<br>
